...
export function Chat({ messages, onSendMessage, businessName, isLoading }: ChatProps) {
  ...
  return (
    <div className="flex flex-col h-full flex-1 bg-white shadow-sm border border-gray-200 border-t-0 rounded-xl">
      <div className="bg-slate-800 shadow-md text-white h-12 px-4 flex items-center rounded-t-xl">
